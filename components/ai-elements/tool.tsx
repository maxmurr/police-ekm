...
export const ToolOutput = ({ className, output, errorText, ...props }: ToolOutputProps) => {
  ...
  return (
    <div className={cn("space-y-2 p-4", className)} {...props}>
      ...
      <div
        className={cn(
          "overflow-x-auto rounded-md text-xs scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted hover:scrollbar-thumb-muted-foreground [&_table]:w-full",
