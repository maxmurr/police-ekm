---
name: mongodb-usage
description: MongoDB best practices and query guidance. Use when user asks to "query MongoDB", "show database collections", "get collection schema", "list MongoDB databases", "search records in MongoDB", or "check database indexes".
---

# MongoDB Best Practices

**MCP Limitation**: This MCP operates in READ-ONLY mode. No write, update, or delete operations are possible.
